...
public class TransactionServiceImpl implements TransactionService {
    ...
    /**
     * this method allows customer to transfer amount
     * 
     * @param AccountReqDto provide account details to transfer amount
     * @return BigDecimal remaining balance
     * 
     */
    @Override
	...
	return "amount successfully transferred balance is:" + fromAccount.getBalance();
    }
}
